...
description: "基于Vue实现动态组织结构图"
pubDate: 2018-08-03T02:34:28.000Z
...
![Vue-Tree-Chart 动态家谱组织结构图示例](/asset/vue-tree-chart.png)
...
![按代拆分后的树形节点数据结构示意](/asset/nodes-1.png)

#### 二、按“代”绘制节点

有了上一步的数据，再将每一代的节点从上到下生成出来简直不要太容易，然后居中一下，树形结构基本就出来了：

![按代绘制节点后的树形结构布局](/asset/nodes-2.png)
...
![计算节点间距后的组织结构图效果](/asset/nodes-3.png)
...
![利用 Table 标签实现节点连线的结构示意](/asset/nodes-4.png)
